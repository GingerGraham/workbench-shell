# Contributing to workbench-shell

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add shell`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-shell.git
cd workbench-shell
...
wb dev shell
# — or directly:
wb track shell --branch <your-branch>
```
